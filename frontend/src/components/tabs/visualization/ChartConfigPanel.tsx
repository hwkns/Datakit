...
import { BarChart4, Save, RefreshCw, Trash } from "lucide-react";
...
const ChartConfigPanel: React.FC = () => {
  const { currentChart, updateCurrentChart, saveCurrentChart, colorPalettes } =
    useChartsStore();
  ...
  return (
    <div className="p-4">
      ...
      <div className="mt-6 flex space-x-2">
        <Button variant="primary" className="flex-1" onClick={saveCurrentChart}>
